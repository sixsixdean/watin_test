...
namespace WatiN.Core
{
    ...
    public class IE : Browser
    {
        ...
        public override void Close()
        {
            ...
            {
                Logger.LogAction((LogFunction log) =>
                {
                    log("Closing browser '{0}'", Title);
                });
            }
        ...
        public bool Visible
        {
            get
            {
                return _ieBrowser.Visible;
            }
            set
            {
                _ieBrowser.Visible = value;
            }
        }
        ...
        private HtmlDialog FindHtmlDialog(Constraint findBy, int timeout)
        {
            Logger.LogAction((LogFunction log) =>
            {
                log("Busy finding HTMLDialog matching criteria: {0}", findBy);
            });
