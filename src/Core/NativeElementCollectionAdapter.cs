...
namespace WatiN.Core
{
    ...
    internal class NativeElementCollectionAdapter : IElementContainer
    {
        ...
        public AreaCollection Areas
        {
            get
            {
                return new AreaCollection(domContainer, CreateElementFinder<Area>(null));
            }
        }
        ...
        public ImageButton ImageButton(string elementId)
        {
            return ImageButton(Find.ByDefault(elementId));
        }

        public ImageButton ImageButton(Regex elementId)
        {
            return ImageButton(Find.ByDefault(elementId));
        }

        public ImageButton ImageButton(Predicate<ImageButton> predicate)
        {
            return ImageButton(Find.ByElement(predicate));
        }

        public ImageButton ImageButton(Constraint findBy)
        {
            return new ImageButton(domContainer, CreateElementFinder<ImageButton>(findBy));
        }
        ...
        public ButtonCollection Buttons
        {
            get
            {
                return new ButtonCollection(domContainer, CreateElementFinder<Button>(null));
            }
        }
        ...
        public CheckBoxCollection CheckBoxes
        {
            get
            {
                return new CheckBoxCollection(domContainer, CreateElementFinder<CheckBox>(null));
            }
        }
        ...
        public ElementCollection Elements
        {
            get
            {
                return new ElementCollection(domContainer, CreateElementFinder<Element>(null));
            }
        }
        ...
        public FileUploadCollection FileUploads
        {
            get
            {
                return new FileUploadCollection(domContainer, CreateElementFinder<FileUpload>(null));
            }
        }
        ...
        public FormCollection Forms
        {
            get
            {
                return new FormCollection(domContainer, CreateElementFinder<Form>(null));
            }
        }
        ...
        public LabelCollection Labels
        {
            get
            {
                return new LabelCollection(domContainer, CreateElementFinder<Label>(null));
            }
        }
        ...
        public LinkCollection Links
        {
            get
            {
                return new LinkCollection(domContainer, CreateElementFinder<Link>(null));
            }
        }
        ...
        public ListCollection Lists
        {
            get
            {
                return new ListCollection(domContainer, CreateElementFinder<List>(null));
            }
        }
        ...
        public ListItemCollection ListItems
        {
            get
            {
                return new ListItemCollection(domContainer, CreateElementFinder<ListItem>(null));
            }
        }
        ...
        public ParaCollection Paras
        {
            get
            {
                return new ParaCollection(domContainer, CreateElementFinder<Para>(null));
            }
        }
        ...
        public RadioButtonCollection RadioButtons
        {
            get
            {
                return new RadioButtonCollection(domContainer, CreateElementFinder<RadioButton>(null));
            }
        }
        ...
        public SelectListCollection SelectLists
        {
            get
            {
                return new SelectListCollection(domContainer, CreateElementFinder<SelectList>(null));
            }
        }
        ...
        public TableCollection Tables
        {
            get
            {
                return new TableCollection(domContainer, CreateElementFinder<Table>(null));
            }
        }
        ...
        public TableBodyCollection TableBodies
        {
            get
            {
                return new TableBodyCollection(domContainer, CreateElementFinder<TableBody>(null));
            }
        }
        ...
        public TableCellCollection TableCells
        {
            get
            {
                return new TableCellCollection(domContainer, CreateElementFinder<TableCell>(null));
            }
        }
        ...
        public TableRowCollection TableRows
        {
            get
            {
                return new TableRowCollection(domContainer, CreateElementFinder<TableRow>(null));
            }
        }
        ...
        public TextFieldCollection TextFields
        {
            get
            {
                return new TextFieldCollection(domContainer, CreateElementFinder<TextField>(null));
            }
        }
        ...
        public SpanCollection Spans
        {
            get
            {
                return new SpanCollection(domContainer, CreateElementFinder<Span>(null));
            }
        }
        ...
        public DivCollection Divs
        {
            get
            {
                return new DivCollection(domContainer, CreateElementFinder<Div>(null));
            }
        }
        ...
        public ImageCollection Images
        {
            get
            {
                return new ImageCollection(domContainer, CreateElementFinder<Image>(null));
            }
        }
