...
namespace WatiN.Core
{
	...
	public abstract class Document : Component, IElementContainer, IDisposable
	{
        ...
        public virtual ImageButton ImageButton(string elementId)
        {
            return AllElements.ImageButton(elementId);
        }

         public virtual ImageButton ImageButton(Regex elementId)
        {
            return AllElements.ImageButton(elementId);
        }

         public virtual ImageButton ImageButton(Predicate<ImageButton> predicate)
        {
            return AllElements.ImageButton(predicate);
        }

        public virtual ImageButton ImageButton(Constraint findBy)
        {
            return AllElements.ImageButton(findBy);
        }
